...
public class BoxingLessonsActivity extends YouTubeBaseActivity {

    TabLayout.Tab Abs, Legs, Chest, Arms, Back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boxinglessons);

        btnPlay = (Button) findViewById(R.id.btnPlay);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.mYoutubeView);
